...
$(builddir)/fca-component-$(THREAD_MODEL).o: force
	keeptmps='$(KEEPTMPS)'; \
	/usr/bin/gcc  $(LIBCFLAGS)   $(FCA_LIBDIR) -l$(FCA_LIBS) -o $@ -c $(fca_srcdir)/gasnet_fca_component.c

$(builddir)/fca-ops-$(THREAD_MODEL).o: force
	keeptmps='$(KEEPTMPS)'; \
	/usr/bin/gcc  $(LIBCFLAGS)   $(FCA_LIBDIR) -l$(FCA_LIBS) -o $@ -c $(fca_srcdir)/gasnet_fca_ops.c
