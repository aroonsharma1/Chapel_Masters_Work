...
//		local {
// 			writeln(myLocArr, "\n:", myFollowThisDom, "\n-", myLocArr[1]);
// 			for e in myLocArr.myElems(myFollowThisDom) do
// 				yield e;
//		}
		local {
...
//need to do slice get, since block cyclic has block size that needs to be skipped

		//copy remote slice into buf
...
// 		}
		...
		//copy buf back into remote slice
...
// 			1);
		...
		//if not able to do optimization
		//
