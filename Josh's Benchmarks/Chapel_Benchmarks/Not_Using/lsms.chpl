...
/*    const gridDist1  = gridDom dmapped CyclicZipOpt(startIdx=gridDom.low);
    ...
    if dist == "NONE" {
        ...
        var gridDist1 = gridDom dmapped CyclicZipOpt(startIdx=gridDom.high);
        var gridDist2 = gridDom dmapped CyclicZipOpt(startIdx=gridDom.high);
        kernel_lsms(gridDist1, gridDist2);  
    } else if dist == "C" {
        var gridDist1 = gridDom dmapped Cyclic(startIdx=gridDom.low);
        var gridDist2 = gridDom dmapped Cyclic(startIdx=gridDom.low);
        kernel_lsms(gridDist1, gridDist2); 
    } else if dist == "B" {
