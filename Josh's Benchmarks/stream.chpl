...
//
use BlockDist, Time, Types, Random, CyclicZipOpt;
...
/*  const ProblemSpace: domain(1) dmapped Block(boundingBox={1..m}) = {1..m};*/
    const ProblemSpace = mydom dmapped CyclicZipOpt(startIdx=mydom.low);
  ...
  for trial in 1..numTrials {                        // loop over the trials
    ...
    //
    A(1..m-1) = B(2..m) + alpha * C(2..m);
/*    forall (a,b, c) in zip(A, B, C) do
      a = b + alpha * c;*/
/*    forall (a1,a2,b1) in zip(A, B, C) {
        a1 = a2 + b1;
    }
*/
